...
当前工作树还包含 LF-FastWAM 语言遵守增强 MVP。结构说明、B0/B1/M1
受控训练、测试及语言干预评估命令见
...
同场景 RoboTwin Correct / Shuffle（DTL）/ Counterfactual（CIS）评测：
...
严格配对协议、正式实验命令、输出格式和适用范围见
[`docs/ROBOTWIN_CIS.md`](docs/ROBOTWIN_CIS.md)。
