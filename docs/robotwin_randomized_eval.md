...
Preflight rejected the initially proposed 91385000–91389399 ranges because the preceding clean DEV trial already used them. No randomized scenes or policies had been run. A read-only archived-seed inventory identified 91305000–91309399 as the first five unused thousand-seed blocks; these ranges were frozen before scene access.
