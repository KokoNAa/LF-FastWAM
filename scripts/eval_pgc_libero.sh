...
if version == 9:
    ...
    expected_action_trainable_scope = (
        (
            ...
            if objective in {30, 31, 32, 33, 34, 35, 36} else
    ...
    expected_gate_contract = (
        "frozen_v928_gate_no_optimization" if objective in {30, 31, 32, 33, 34, 35, 36} else
    ...
    if objective >= 29 and (
        ...
        != ("injector_only_with_frozen_v928_teacher_and_gate" if objective in {30, 31, 32, 33, 34, 35, 36}
    ...
    if objective in {30, 31, 32, 33, 34, 35, 36}:
        ...
        if objective in {31, 32, 33, 34, 35, 36} and (
