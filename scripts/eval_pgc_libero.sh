...
if version == 9:
    ...
    if objective not in set(range(1, 33)):
        raise SystemExit(
    ...
    expected_gate_contract = (
        "frozen_v928_gate_no_optimization" if objective in {30, 31, 32} else
    ...
    if objective >= 29 and (
        ...
        != ("injector_only_with_frozen_v928_teacher_and_gate" if objective in {30, 31, 32}
